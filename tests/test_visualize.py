...
def test_get_overall_status():
    ...
    assert _get_overall_status({'test1': True, 'test2': False, 'test3': True, 'test4': True, 'test5': True}) == 'pass'
    
    # Below threshold
    assert _get_overall_status({'test1': True, 'test2': False, 'test3': False}) == 'fail'
